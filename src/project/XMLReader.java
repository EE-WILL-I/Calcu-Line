...
public class XMLReader {
    ...
    private final String PATH_TO_CONFIG = "src/configs/config.xml", PATH_TO_TEXT_DATA = "src/configs/text data.xml";
    ...
    public boolean readTextData() {
        try {
            ...
            onTextDataChanged.broadcast(new Events.EventArgs());
            return true;
        } catch (ParserConfigurationException | SAXException | IOException e) {
